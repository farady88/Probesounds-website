...
class ErrorBoundary extends reactExports.Component {
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-black text-white flex items-center justify-center p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Alert, { variant: "destructive", className: "bg-gray-950 border-red-900", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-5 w-5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertTitle, { className: "text-xl font-bold mb-2", children: "Something went wrong" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDescription, { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300", children: "We encountered an unexpected error while loading the page. This has been logged for investigation." }),
          this.state.error && /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "mt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { className: "cursor-pointer text-sm text-gray-400 hover:text-gray-300", children: "Technical details" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "mt-2 p-4 bg-black rounded text-xs text-red-400 overflow-auto", children: this.state.error.toString() })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4 mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen flex flex-col bg-black text-white overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-radial from-gray-900/20 via-black to-black animate-pulse-slow pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `hidden md:block fixed top-6 left-6 z-50 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-36 lg:w-[10.5rem] overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative flex-1 flex flex-col items-center justify-center px-6 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `md:hidden w-full mb-12 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center animate-fade-in-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-64 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: imageError ? fallbackLogoPath : logoPath,
              alt: "Probe Logo",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `space-y-8 md:space-y-10 lg:space-y-12 flex flex-col items-center text-center transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "h1",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: "Coming Soon" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-20 h-20 flex items-center justify-center rounded-full border border-gray-700 group-hover:border-white transition-all duration-500 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiInstagram, { className: "w-9 h-9 text-gray-500 group-hover:text-white transition-colors duration-500" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500 group-hover:text-white transition-colors duration-500 tracking-wider font-light", children: "@probesounds" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-20 h-20 flex items-center justify-center rounded-full border border-gray-700 group-hover:border-white transition-all duration-500 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiTiktok, { className: "w-9 h-9 text-gray-500 group-hover:text-white transition-colors duration-500" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500 group-hover:text-white transition-colors duration-500 tracking-wider font-light", children: "@probe_sounds" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-20 h-20 flex items-center justify-center rounded-full border border-gray-700 group-hover:border-white transition-all duration-500 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiYoutube, { className: "w-9 h-9 text-gray-500 group-hover:text-white transition-colors duration-500" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500 group-hover:text-white transition-colors duration-500 tracking-wider font-light", children: "@Probe_Sounds" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-20 h-20 flex items-center justify-center rounded-full border border-gray-700 group-hover:border-white transition-all duration-500 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiSpotify, { className: "w-9 h-9 text-gray-500 group-hover:text-white transition-colors duration-500" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500 group-hover:text-white transition-colors duration-500 tracking-wider font-light", children: "@probesounds" })
                      ]
                    }
                  )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative py-8 px-6 border-t border-gray-900/50 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "© 2025 Probe & Co. All rights reserved." }) }) })
  ] });
}
